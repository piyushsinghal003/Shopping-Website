		 ...
		 <h3 class="tittle">ABOUT</h3>
				<div class="about-top">
					...
					<div class="col-md-7 about-top-right">
						...
						<p> NUCLEUS ELECTRO ENTERPRISES (ISO 9001) certified company. It specializes in the manufacture of a wide range of transformers, stabilizers, Battery chargers , Servo voltage stabilizers, welding machines, Inverters, UPS etc. initiated into commercial production in 1974 & growing further. It is nurtured by professionals, technocrats with high profile & several years of experience in the field of design, manufacture. Our products are designed with the latest state-of-the-art technology where manufacturing is carried out by highly skilled technicians. The supervision of manufacturing & quality assurance is looked after by our qualified engineers with years of experience & through knowledge.	</p>
						<p>"NUCLEUS", a technology driven company has been satisfying electrical protection and power handling needs of core structure and consumer durable alike. </p>
					</div>
					<div class="clearfix"></div>
				</div>
		</div>	 
			...
			<div class="main">
				<div class="col-md-3 view-grid">
					<div class="view fifth-effect">
						 <a href="#" title="Full Image"><img src="images/piyush.jpg" alt=""width="250px" height="250px" /></a>
						 <div class="mask"></div>
					</div> 
				</div>
				<div class="col-md-3 view-grid">
					<div class="view fifth-effect">
						 <a href="#" title="Full Image"><img src="images/pushkar.jpg" alt=""width="250px" height="250px" /></a>
						 <div class="mask"></div>
					</div> 
				</div>
				<div class="col-md-3 view-grid">
					<div class="view fifth-effect">
						 <a href="#" title="Full Image"><img src="images/piyush1.jpg" alt="" width="250px" height="250px"/></a>
						 <div class="mask"></div>
					</div> 
				</div>
				<div class="col-md-3 view-grid">
					<div class="view fifth-effect">
						 <a href="#" title="Full Image"><img src="images/piyush2.jpg" alt="" width="250px" height="250px"/></a>
						 <div class="mask"></div>
					</div> 
				</div>
				<div class="clearfix"></div>
...
<div class="team">
	<div class="container">
		<h3 class="tittle">CERTIFICATIONS WE HAVE</h3>
			<div class="main">
				<div class="col-md-3 view-grid">
					<div class="view fifth-effect">
						 <a href="#" title="Full Image"><img src="images/piyush.jpg" alt=""width="250px" height="250px" /></a>
	...
	<div class="container">
		<h3 class="tittle">OUR CUSTOMERS</h3>
			...
			<marquee>
				<div class="col-md-3 view-grid">
					<div class="view fifth-effect">
						 <a href="#" title="Full Image"><img src="images/sbi.jpg" alt=""width="250px" height="250px" /></a>
						 <div class="mask"></div>
					</div> 
				</div>
				<div class="col-md-3 view-grid">
					<div class="view fifth-effect">
						 <a href="#" title="Full Image"><img src="images/railway.png" alt=""width="250px" height="250px" /></a>
						 <div class="mask"></div>
					</div> 
				</div>
				<div class="col-md-3 view-grid">
					<div class="view fifth-effect">
						 <a href="#" title="Full Image"><img src="images/bhel.png" alt="" width="250px" height="250px"/></a>
						 <div class="mask"></div>
					</div> 
				</div>
				<div class="col-md-3 view-grid">
					<div class="view fifth-effect">
						 <a href="#" title="Full Image"><img src="images/radio.png" alt="" width="250px" height="250px"/></a>
						 <div class="mask"></div>
					</div> 
				</div>
				<div class="clearfix"></div>
